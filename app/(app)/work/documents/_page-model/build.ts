...
export function buildDocumentsIndexPageModel({
    ...
    return {
        meta: {
            title: "Documents",
            description: "Program documentation and authored artifacts in scope.",
            breadcrumbs: [
        ...
        refs: {
            visible: documents.slice(0, 12).map((document) => ({
                ...
                href: `/work/documents/${document.id}`,
            })),
        },
        sections: [
            {
...
export function buildDocumentsDetailPageModel({
    ...
    return {
        meta: {
            ...
            description:
                document.summary ??
                "Program document detail and supporting attachments.",
            breadcrumbs: [
                { label: "Work", href: "/work" },
...
export function buildDocumentsRouteContract(
    ...
    return {
        ...
        railPayloadCandidate: buildRailPayload({
            scope: { type: "documents_detail", id: params.document.id },
